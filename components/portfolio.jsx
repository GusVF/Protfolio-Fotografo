    ...
    <div className="max-w-[1240px] max-auto py-16 text-center">
      ...
      <div className="grid grid-rows-none md:grid-cols-5 p-4 gap-4">
        <div className="w-full h-full col-span-2 md:col-span-3 row-span-2">
          <Image 
            src='https://images.unsplash.com/photo-1515238152791-8216bfdf89a7?w=1600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fGJlYWNofGVufDB8fDB8fHww'
            alt="/"
            layout="responsive"
            width='677'
            height='451'
